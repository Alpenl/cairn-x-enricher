> 2026-09-22 B07 最新局部证据：[状态、候选、来源与独立实体](evidence/B07-20260922-state.md)。受测 S `0a38e52` / E `3520dc1`；184 Worker、69 Android unit、8 真实跨仓，本地 API26 18 普通 + 7 真实阶段及小屏大字体通过。完整原范围仍未完成，特别保留 empty 后单标签 reset、缓存竞争和全部端到端矩阵。远端与完整记录见报告。
